...
var workAmount=function(valuetoadd){
   ...
   function bankAmount() {
    ...
    if (newworkamount >0 ){
        ...
        if (m > outstandingloan) {
         ...
         var updatedm=parseInt(document.getElementById("payloan").innerText=outstandingloan - m+" kr");
         
      if(updatedm<=0) {
        document.getElementById("payloan").innerText=0+" kr";
       }
   ...
   function repayloanbtn() {
    ...
    if (newworkamount >0 ){
        ...
        if(outstandingloan >  0 ) { 
          if(newworkamount>outstandingloan){
         ...
         a=  newworkamount- outstandingloan;
         updatevalue();
        }
        else if(outstandingloan>=newworkamount){
          transferamounttoloan=parseFloat(transferamountobank);
          transferamountobank =transferamountobank -transferamounttoloan
...
var pic="https://noroff-komputer-store-api.herokuapp.com/assets/";
 async function nrenderUsers(name = null) {
  
  console.log(name);
  let nusers = await getUsers();
  let html = '';
  //  <img src="https://noroff-komputer-store-api.herokuapp.com/assets/images/" alt="" >
